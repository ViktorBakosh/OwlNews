...
//        {
//            string Name = "zakarpattia";
//            Console.Title = "Zakarpattia";
//            var NEWS = ReadZakarpattia("http://www.mukachevo.net/ua/news/index", "//div[@class='row news-index-list']//div[@class='col-sm-12 news-index-list-container']//div[@class='row']", Name);
//            if (NEWS != null)
//                foreach (var item in NEWS)
//                {
//                    await DB.DATABASE_INSERT(Name,
